...
2️⃣ Feature Engineering
    1.Extracted Year, Month, Month Name
    2.Created rolling average for trend smoothing
...
2.Increase marketing for high-performing categories
3.Optimize inventory before peak sales months
4.Improve sales strategy in low-performing regions
...
1.Calculated Month-over-Month growth %
2.Identified peak and low sales periods
3.Detected seasonal fluctuations
